<?php
	...
	$sql = "INSERT INTO score_board (player_id, player_name, score, death_position, date_created, version) "
		."VALUES ('".$fb_user_id."', '".$first_name."', '".$_POST["score"]."','".$_POST["position_x"]."', now(),'".$_POST["version"]."')";
